function Location() {
    return (
        <div className="mt-3">
            <div>
                <p className="font-1 m-1">Lokasi Acara</p>
                <iframe
                    title="location"
            ...
            <p className="mt-1 font-size-1 mb-1">Graha Sofia</p>
            <p>Jl. Otto Iskandardinata, Karanganyar, Kec. Subang, Kabupaten Subang, Jawa Barat 41215</p>
            <div className="m-2">
                <a className="maps-link" href="https://maps.app.goo.gl/Rb9hH9uaaTzxmfQn7" target="_blank" role="button" rel="noreferrer">Buka Maps</a>
            </div>
        </div>
    )
}
