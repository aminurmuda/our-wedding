...
function Pengantin() {
    return (
        <div>
            <img src="images/bismillah.webp" alt="bismillah" className="bismillah scale-up" width="192" height="43" />
            ...
            <div className="mb-1 mx-1">
                ...
                <p className="mt-0-5 slide-down">Putra dari Bapak Aris Muda Nasution (rahimahullah) dan Ibu Jean Leila Hanoum </p>
            </div>
        </div>
    )
}
